...
opt_specs() ->
	[
		...
		{system_id, $u, "system_id", {string, "user"}, "SMSC username"},
		...
		{source, $s, "source", string, "SMS source address Addr[,Ton=1,Npi=1]"},
		{destination , $d, "destination", string, "SMS destination address Addr[,Ton=1,Npi=1]"},
		{body, $b, "body", string, "SMS body, randomly generated by default"},
		{length, $l, "length", {integer, ?SM_MAX_SIZE}, "Randomly generated body length"},
